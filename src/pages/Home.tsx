...
import { UPSPanel } from '@/components/UPSPanel/UPSPanel';
...
export default function Home() {
  ...
  const { alerts, visualFlash, powerMode } = useMonitorStore();
    ...
    `}>
      ...
      <div className="flex-1 flex overflow-hidden relative z-10">
        ...
        <div className="flex-1 h-full flex flex-col gap-4 p-4 bg-cyber-bg/50">
          ...
          <div className="flex-1 grid grid-rows-[auto_1fr] gap-4 min-h-0 overflow-y-auto">
            <UPSPanel />
